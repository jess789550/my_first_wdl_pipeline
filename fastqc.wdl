...
task fastqc_task {
    ...
    command {
        /opt/software/FastQC/fastqc ${input_fastq_1} > ${basename(input_fastq_1, ".fastq.gz")}.html
        /opt/software/FastQC/fastqc ${input_fastq_2} > ${basename(input_fastq_2, ".fastq.gz")}.html
    }
